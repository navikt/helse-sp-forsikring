    ...
    override fun onPacket(packet: JsonMessage, context: MessageContext, metadata: MessageMetadata, meterRegistry: MeterRegistry) {
        ...
        medMdc(MdcKey.MELDING_ID to meldingId.toString(), MdcKey.FORSIKRINGSVURDERING_ID to forsikringsvurderingId.toString()) {
            ...
            if (!forsikringsvurdering.harForsikring
                || forsikringsvurdering.dekning == null
                || forsikringsvurdering.forsikringskategori == Forsikringskategori.KollektivForsikring
            ) return@medMdc

            val dager: List<Dag> = packet["utbetalingsdager"].mapArray {
                Dag(
            ...
            tellingDao.lagre(
                ...
                harDekningIVentetid = forsikringsvurdering.dekning.iVentetid,
...
data class Dag(val iVentetid: Boolean, val beløpTilBruker: Int)
